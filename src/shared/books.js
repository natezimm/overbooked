export const BOOKS = [
    {
        ...
        image: "/assets/images/monte-cristo.jpeg",
        pages: 1276,
        featured: false,
    ...
    },
    {
        ...
        "And the book is The Hitchhiker’s Guide to the Galaxy . . . which helpfully has the words DON’T PANIC inscribed in large, friendly letters on its cover. Douglas Adams’s mega-selling pop-culture classic " + 
        "sends logic into orbit, plays havoc with both time and physics, offers up pithy commentary on such things as ballpoint pens, potted plants, and digital watches . . . and, most important, reveals the " +
        "ultimate answer to life, the universe, and everything. Now, if you could only figure out the question. . . ."
    },
    {
        id: 2,
        name:"Harry Potter and the Sorcerer's Stone",
        image: "/assets/images/sorcerers-stone.jpeg",
        pages: 309,
        featured: false,
